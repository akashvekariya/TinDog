...
<head>
   ...
   <link type="text/css" rel="stylesheet" href="css/adoptdog.css" />
...
<body>
   ...
   <div class="main_container_IN">
      <nav class="nav_container_IN">
         ...
         <div class="nav_menu_IN">
            <a class="page_navigation active" id="FstPage">Adopt dog</a>
      ...
      <div class="content_container_IN">
         ...
         $dog_total_id = $obj->get_total_card_length();
         ...
         while($line = mysqli_fetch_assoc($dog_total_id)) {
            $data = $obj->get_cards_data($line['dog_id']);
         ?>

         <!-----------------cards------------------>
         <div class="card_AD" id="<?php echo $line['dog_id'];?>_card" onclick="card_click(this)">
            <div class="image_container_AD">
               <img src="database/<?php echo $data['image_url']?>.png">
               <div class="owner_name_container_AD">
                  <p id="owner_name_LD_1">- From <?php echo $data['firstname'] . ' ' . $data['lastname'];?></p>
               </div>
            </div>
   ...
   <script type="text/javascript" src="js/adoptdog.js"></script>
